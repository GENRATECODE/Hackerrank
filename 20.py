...
The list of room numbers contains  31 elements. Since k  is 5 , there must be  6 groups of families. In the given list, all of the numbers repeat 5  times except for room number .
Hence,  is the Captain's room number 8.
'''